...
description: 'Learn how to create and manage plugin settings panel in Blinko'
---

# Plugin Settings Panel

Each Blinko plugin can have its own settings panel that allows users to customize the plugin's behavior.
